...
class PhysMamba(nn.Module):
    def __init__(self, theta=0.5, drop_rate1=0.25, drop_rate2=0.5, frames=128, n_channels=3):
        super(PhysMamba, self).__init__()

        self.ConvBlock1 = conv_block(n_channels, 16, [1, 5, 5], stride=1, padding=[0, 2, 2])
