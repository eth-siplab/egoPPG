...
from preprocessing_helper import load_movisens_data, load_shimmer_data, load_md_data, load_biopac_data
...
def main():
    ...
    for participant in participants:
        ...
        if ego_rr:
            imu_devices = ['aria', 'ms', 'biopac']
        elif participant in configs['exclusion_list_shimmer']:
        ...
        if 'biopac' in imu_devices:
            biopac_df = load_biopac_data(data_path_temp)
        ...
        for imu_device in imu_devices:
            ...
            elif imu_device == 'biopac':
                fs_temp = fs_all['biopac']
                imu_temp = -biopac_df.to_numpy()
            else:
