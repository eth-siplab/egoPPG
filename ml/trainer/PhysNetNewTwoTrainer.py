...
from source.ml.models.PhysNetNewTwo import PhysNetNewTwo
from source.ml.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class PhysNetNewTwoTrainer(BaseTrainer):
    def __init__(self, config, data_loader, trainer_params):
        ...
        self.model = PhysNetNewTwo(frames=config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH).to(self.device)
