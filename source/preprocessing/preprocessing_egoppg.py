...
def preprocess_timeseries(provider, participant, configs, data_path, save_path_sp, save_path_ml, synch_path,
    ...
    for sensor in sensors:
        ...
        if sensor in ['ms_ecg', 'shimmer', 'md', 'aria_imu_right']:
            fig, ax = plt.subplots()
        ...
        # Resample PPG signal to same fps than Aria glasses and then save as .npy file
        if sensor in ['shimmer', 'md', 'aria_imu_right']:
