...
from source.ml.models.PhysNetNewIMU import PhysNetNewIMU
from source.ml.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class PhysNetNewIMUTrainer(BaseTrainer):
    def __init__(self, config, data_loader, trainer_params):
        ...
        self.model = PhysNetNewIMU(frames=config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH).to(self.device)
