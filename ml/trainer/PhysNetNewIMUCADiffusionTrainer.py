...
from source.ml.models.PhysNetNewIMUCADiffusion import PhysNetNewIMUCADiffusionUNet
from source.ml.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class PhysNetNewIMUCADiffusionTrainer(BaseTrainer):
    def __init__(self, config, data_loader, trainer_params):
        ...
        self.model = PhysNetNewIMUCADiffusionUNet(diffusion_steps=50, frames=config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH,
    ...
    def train(self, data_loader):
        ...
        for epoch in range(self.max_epoch_num):
            ...
            for idx, batch in enumerate(tbar):
                ...
                pred, diffusion_loss = self.model(batch[0][0].to(self.device), batch[0][1].to(self.device),
                ...
                loss = self.loss_model(pred, label, batch[0][1].to(self.device))
