...
from source.ml.models.PhysNetTemp import PhysNetTemp
from source.ml.trainer.BaseTrainer import BaseTrainer
from tqdm import tqdm


class PhysNetTempTrainer(BaseTrainer):
    def __init__(self, config, data_loader, trainer_params):
        ...
        self.model = PhysNetTemp(frames=config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH).to(self.device)
