...
from ml.loss.PhysFormerLossComputer import TorchLossComputer
from ml.loss.PhysNetNegPearsonLoss import Neg_Pearson
from ml.models.PhysFormer import ViT_ST_ST_Compact3_TDC_gra_sharp
...
class PhysFormerTrainer(BaseTrainer):
    def __init__(self, config, data_loader, trainer_params):
        ...
        self.model = ViT_ST_ST_Compact3_TDC_gra_sharp(
            ...
            num_layers=self.num_layers, dropout_rate=self.dropout_rate, theta=self.theta).to(self.device)
        ...
        if config.TOOLBOX_MODE == "train_and_test":
            ...
            # self.criterion_Pearson = torch.nn.MSELoss()  # obtained better results with this
    ...
    def train(self, data_loader):
        ...
        for epoch in range(self.max_epoch_num):
            ...
            for idx, batch in enumerate(tbar):
                ...
                gra_sharp = 2.0
                pred, _, _, _ = self.model(data, gra_sharp)
                ...
                if idx % 50 == 49:  # print every 100 mini-batches
